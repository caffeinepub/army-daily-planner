...
export class Backend implements backendInterface {
    ...
    async getMonthHistory(arg0: bigint, arg1: bigint): Promise<Array<DaySummary>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonthHistory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasksByDate(arg0: bigint): Promise<Array<Task>> {
        if (this.processError) {
            try {
    ...
    async toggleTask(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateTask(arg0: bigint, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
